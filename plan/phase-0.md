...
### 3. Bright Data integration (`scrape.py`, `scrape_download.py`, `ingest_records.py`)

- Implement **`scrape.py`** to:
...
- Implement **`scrape_download.py`** to:
...
- Implement **`ingest_records.py`** to:
